...
def register():
    logger.info('Visiting register page.')
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        logger.info('{} registered successfully!'.format(username))
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user is not None and user.verify_password(password):
            ...
            logger.info('{} login successfully.'.format(user.username))
...
def logout():
    logout_user()
    logger.info('{} logged out successfully.'.format(current_user))
