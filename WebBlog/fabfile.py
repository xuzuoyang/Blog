...
env.user = 'xuzuoyang'
env.sudo_user = 'root'
env.hosts = ['47.94.11.212']
env.port = 2002

db_user = 'root'
db_password = '584224'

_TAR_FILE = 'dist-webblog.tar.gz'

_REMOTE_TMP_TAR = '/tmp/%s' % _TAR_FILE

_REMOTE_BASE_DIR = '/home/xuzuoyang/srv/webblog'
...
def build():
    ...
    Build dist package.
    '''
    includes = ['confs', 'models', 'static', 'templates', '*.py'] # favicon.ico transwarp
...
def deploy():
    ...
    with settings(warn_only=True):
        sudo('supervisorctl stop webblog')
        sudo('supervisorctl start webblog')
